...
const wordBreak = require('../../../main/algorithm/medium/WordBreak');

describe('Word Break', function () {
    it('"leetcode" should return true', function () {
        expect(wordBreak('leetcode', ['leet', 'code'])).to.equal(true);
    });

    it('"applepenapple" should return true', function () {
        expect(wordBreak('applepenapple', ['apple', 'pen'])).to.equal(true);
    });

    it('"catsandog" should return false', function () {
        expect(wordBreak('catsandog', ['cats', 'dog', 'sand', 'and', 'cat'])).to.equal(false);
    });

    it('"fohhemkkaecojceoaejkkoedkofhmohkcjmkggcmnami" should return true', function () {
        expect(wordBreak('fohhemkkaecojceoaejkkoedkofhmohkcjmkggcmnami', ['kfomka', 'hecagbngambii',
            ...
            'iohchafbega', 'kjejfhbco', 'anlhhhhg'])).to.equal(true);
    });
});